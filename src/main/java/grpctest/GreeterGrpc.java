...
public class GreeterGrpc {
  ...
  public static final io.grpc.MethodDescriptor<grpctest.HelloRequest,
      grpctest.HelloReply> METHOD_SAY_HELLO =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "helloworld.Greeter", "SayHello"),
          io.grpc.protobuf.ProtoUtils.marshaller(grpctest.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(grpctest.HelloReply.getDefaultInstance()));
  ...
  public static interface Greeter {
     ...
     * </pre>
     */
    public void sayHello(grpctest.HelloRequest request,
        io.grpc.stub.StreamObserver<grpctest.HelloReply> responseObserver);
  }
  ...
  public static interface GreeterBlockingClient {
     ...
     * </pre>
     */
    public grpctest.HelloReply sayHello(grpctest.HelloRequest request);
  }
  ...
  public static interface GreeterFutureClient {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpctest.HelloReply> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((grpctest.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpctest.HelloReply>) responseObserver);
          break;
        default:
